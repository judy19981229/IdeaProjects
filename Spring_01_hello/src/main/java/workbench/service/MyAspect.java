...
public class MyAspect {
    ...
    @Before("execution(* workbench.service.ServiceImpl.doSome(..))")
    ...
    @AfterReturning(value="execution(* workbench.service.ServiceImpl.doSome(..))",
            returning="res")
    ...
    @Pointcut("execution(* workbench.service.ServiceImpl.doOther(..))")
    private void mypt(){}
}
